...
async function callFunction(options, config) {
    ...
    */
    const tcbInstance = instance_1.getInstance(config);
...
exports.getInstance = (config = {}) => {
    if (process.env.TENCENTCLOUD_RUNENV === 'WX_LOCAL_SCF') {
        // @ts-ignore
        const instance = tcb.init(Object.assign(Object.assign(Object.assign({}, tcb.config), config), { env: utils_1.translateEnv(config.env || tcb.config.envName), isHttp: true }));
        ...
        // @ts-ignore
        const instance = tcb.init(Object.assign(Object.assign(Object.assign({}, tcb.config), config), { env: utils_1.translateEnv(config.env || tcb.config.envName) }));
        instance.config.secretId = undefined;
        instance.config.secretKey = undefined;
        instance.config.sessionToken = undefined;
        return instance;
...
exports.fixInstance = () => {
    if (tcb.config.envName === symbol_config_1.SYMBOL_DYNAMIC_CURRENT_ENV) {
        tcb.config.envName = utils_1.translateEnv(tcb.config.envName);
    }
    if (process.env.TENCENTCLOUD_RUNENV === 'WX_LOCAL_SCF') {
        tcb.config.secretId = undefined;
        tcb.config.secretKey = undefined;
        tcb.config.sessionToken = undefined;
        tcb.config.isHttp = true;
    }
};
...
const assert_1 = __webpack_require__(/*! utils/assert */ "./src/utils/assert.ts");
const error_1 = __webpack_require__(/*! utils/error */ "./src/utils/error.ts");
const __1 = __webpack_require__(/*! .. */ "./src/api/functions/index.ts");
const msg_1 = __webpack_require__(/*! utils/msg */ "./src/utils/msg.ts");
const utils_1 = __webpack_require__(/*! utils/utils */ "./src/utils/utils.ts");
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                const result = await cloud.provider.api.callFunction({
                    ...
                    env: utils_1.getEnvFromAPIConfig(options.config, cloud.config, __1.FUNCTIONS_SERVICE_NAME)
                });
...
const assert_1 = __webpack_require__(/*! utils/assert */ "./src/utils/assert.ts");
const error_1 = __webpack_require__(/*! utils/error */ "./src/utils/error.ts");
const __1 = __webpack_require__(/*! .. */ "./src/api/storage/index.ts");
const msg_1 = __webpack_require__(/*! utils/msg */ "./src/utils/msg.ts");
const utils_1 = __webpack_require__(/*! utils/utils */ "./src/utils/utils.ts");
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                const result = await cloud.provider.api.deleteFile({
                    ...
                    env: utils_1.getEnvFromAPIConfig(options.config, cloud.config, __1.STORAGE_SERVICE_NAME),
                });
                return resolve({
